...
public class Entity implements IRuledValue {
	...
	public String getDateString(String fieldName) {
		try {
			return tableMeta.getDateString(dataArray, fieldName, null);
		}
		catch (Exception e) {
			return "error";
		}
	...
	public String getId() {
		try {
			return tableMeta.getString(dataArray, "id", null);
		}
		catch (Exception e) {
			return "error";
		}
	...
	public Integer getInteger(String name) {
		return tableMeta.getInteger(dataArray, name);
	}
	
	public int getInteger(String name, int defaultVaue) {
