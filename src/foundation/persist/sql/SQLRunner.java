...
public class SQLRunner {
	...
	public static Object getObject(NamedSQL namedSQL, int idx) throws Exception {
		return getObject(null, namedSQL, idx);
	}

	public static Object getObject(Connection conn, NamedSQL namedSQL, int idx) throws Exception {
		ResultSet rslt = null;
		Statement stmt = null;
		Object result = null;
