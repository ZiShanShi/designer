...
import designer.options.echart.Label;
import designer.options.echart.Title;
import designer.options.echart.axis.AxisLine;
import designer.options.echart.axis.AxisTick;
...
public class Gauge extends Series<Gauge> {
     ...
     * 坐标轴线，默认显示
     *
     * @see designer.options.echart.series.Line
     */
    private AxisLine axisLine;
    /**
     * 坐标轴小标记，默认显示
     *
     * @see designer.options.echart.axis.AxisTick
     */
    private AxisTick axisTick;
    /**
     * 坐标轴文本标签
     *
     * @see designer.options.echart.Label
     */
    private Label axisLabel;
    /**
     * 主分隔线，默认显示
     *
     * @see designer.options.echart.axis.SplitLine
     */
    private SplitLine splitLine;
    /**
     * 指针样式
     *
     * @see designer.options.echart.series.gauge.Pointer
     */
    private Pointer pointer;
    /**
     * 仪表盘标题
     *
     * @see designer.options.echart.Title
     */
    private Title title;
    /**
     * 仪表盘详情
     *
     * @see designer.options.echart.series.gauge.Detail
     */
