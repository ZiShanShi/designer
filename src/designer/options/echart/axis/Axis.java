...
import designer.options.echart.Component;
...
public abstract class Axis<T> extends AbstractData<T> implements Component {
     ...
     *
     * @see designer.options.echart.code.AxisType
     */
     ...
     * 'right'
     *
     * @see designer.options.echart.code.X
     * @see designer.options.echart.code.Y
     */
     ...
     *
     * @see designer.options.echart.axis.AxisLine
     ...
     *
     * @see designer.options.echart.axis.AxisLabel
     */
