...
import designer.options.echart.LabelLine;
import designer.options.echart.code.Position;
import designer.options.echart.style.*;
...
public abstract class Style<T> implements Serializable {
     ...
     * 饼图标签视觉引导线，默认显示
     *
     * @see designer.options.echart.LabelLine
     */
     ...
     * 和弦图 - 弦样式
     *
     * @see designer.options.echart.style.ChordStyle
     */
    private ChordStyle chordStyle;
    /**
     * 力导向图 - 弦样式
     *
     * @see designer.options.echart.style.NodeStyle
     */
    private NodeStyle nodeStyle;
    /**
     * 力导向图 - 弦样式
     *
     * @see designer.options.echart.style.LinkStyle
     */
